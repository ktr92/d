...
var Ra=a.getBoundingClientRect(),R=Math.round(Ra.top+b.getBoundingClientRect().height-document.querySelector('.teamblock').getBoundingClientRect().top+0);if((Ra.top-P)<=0){if((Ra.top-P)<=R){b.className='stop';b.style.top=-R+'px'}else{b.className='sticky';b.style.top=P+'px'}}else{b.className='';b.style.top=''}
