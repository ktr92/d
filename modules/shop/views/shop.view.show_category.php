...
<div class="col-md-4 col-sm-6 col-xs-12">
	<div class="services__item">
		<div class="services__content" style="background-image: url(<?=$row["img"][0]["vs"]["medium"]?>)">
			<div class="services__mask"><div class="services__trb">
				<a href="<?='/'.$row["link"]?>">
					<div class="services__title"><?=$row["name"]?></div>
					<div class="services__text"><?=$row['anons']?></div>
				</a></div></div>
		</div>
	</div>
</div>
