	...
	<div class="teamblock__item">
		<div class="teamblock__wrappwe">
			<div class="teamblock__content">
				<div class="teamblock__link"><a href="/<?if (! empty($row['link'])) { echo $row['link']; }?>">
						<div class="teamblock__name"><?=$row['name'] ?></div>
						<div class="teamblock__text"><?=$row['anons']?></div>
						<div class="teamblock__img"><img src="<?=$row["img"][0]["vs"]["large"]?>" alt=""></div>
					</a></div>
			</div>
		</div>
	</div>
