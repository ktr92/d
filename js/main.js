...
if ($(document).width() > 991) {
		var a = document.querySelector('.asideform'), b = null, P = 69;  
		...
		function Ascroll() {
		  ...
		  var Ra = a.getBoundingClientRect(),
			  R = Math.round(Ra.top + b.getBoundingClientRect().height - document.querySelector('.teamblock').getBoundingClientRect().top + 0);  
		  if ((Ra.top - P) <= 0) {
			if ((Ra.top - P) <= R) {
			  b.className = 'stop';
			  b.style.top = - R +'px';
